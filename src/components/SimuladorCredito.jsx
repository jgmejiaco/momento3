...
class SimuladorCredito extends React.Component {
    ...
    addSolicitud(e) {
        ...
        if (this.state.tipo_prestamo === "vivienda") {
            ...
            this.state.valor_cuotas = parseFloat(this.state.total_deuda / parseInt(this.state.numero_cuotas));
        }
    ...
    refreshSolicitud() {
        const apiUrl = 'http://localhost:80/web2/momento3_db/showCredito.php';
        fetch(apiUrl)
